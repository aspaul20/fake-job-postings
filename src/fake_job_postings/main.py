...
@hydra.main(version_base=None, config_path=os.path.join(os.path.dirname(__file__),"cfg"), config_name="config")
def train(cfg: DictConfig):
    ...
    # --- DataModule ---
    dm = JobDataLoader(df, meta, tokenizer, batch_size=cfg.train.batch_size, num_workers=cfg.train.num_workers, logger=logger)
